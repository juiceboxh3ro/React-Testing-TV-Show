...
import App from './App'
import { fetchEpisodes as mockFetchEpisodes } from './api/fetchEpisodes'

jest.mock('./api/fetchEpisodes.js')
...
test("Data is processed and 8 episodes from season 1 display", async () => {
  // mock the resolved data
  mockFetchEpisodes.mockResolvedValueOnce(mockEpisodesData);
  ...
  // click season select button
  userEvent.click(getByText(/select a season/i));

  // click season 1
  userEvent.click(getByText(/season 1/i));

  // check for 8 episodes
